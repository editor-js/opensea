...
var o = (a, t, e) => t in a ? d(a, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : a[t] = e;
...
class n {
  constructor({ data: t, config: e, api: s, readOnly: i }) {
    ...
    r(this, "config");
    r(this, "nodes");
    r(this, "scriptUrl", "https://unpkg.com/embeddable-nfts/dist/nft-card.min.js");
    this.data = t, this.config = e, this.api = s, this.readOnly = i, this.nodes = {
      wrapper: null,
      nftCard: null
    };
  }
  render() {
    if (this.nodes.wrapper = document.createElement("div"), this.nodes.wrapper.classList.add(p["opensea-tool"]), this.data.contractAddress && this.data.tokenId && this.renderNftCard(), !document.querySelector(`script[src="${this.scriptUrl}"]`)) {
      const e = document.createElement("script");
      e.src = this.scriptUrl, document.head.appendChild(e);
    }
